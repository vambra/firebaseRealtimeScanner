...
const ModalTwoButtons = ({ visible, title, button1Title, button1Event, button2Title, button2Event }) => {
  return (
    <SafeAreaView>
            ...
            <View style={styles.modalButtons}>
              <View style={styles.buttonView}>
                <TouchableOpacity
                  ...
                  style={styles.button}>
                  <Text style={styles.title}>{button1Title}</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.buttonView}>
                <TouchableOpacity
                  ...
                  style={styles.button}>
                  <Text style={styles.title}>{button2Title}</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
